...
# ============================================================
# 4. kernel/sched/cpufreq_schedutil.c - OMITIDO para evitar errores
# ============================================================
print("[INFO] schedutil.c: omitido para evitar problemas de compilacion")
print("[INFO] GameMode funciona con tepuy_sysfs.c + cpufreq.c + thermal_core.c")
